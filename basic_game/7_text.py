...
# 배경 이미지 불러오기
background = pygame.image.load("basic_game/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("basic_game/character.png")
...
# 적 캐릭터
enemy = pygame.image.load("basic_game/enemy.png")
...
while running:
    ...
    if total_time - elapsed_time <= 0:
        print("타임 아웃")
        time_out = game_font.render("TIme Out!", True, (255, 255, 255))
        screen.blit(time_out, ((screen_width / 2), (screen_height / 2)))
