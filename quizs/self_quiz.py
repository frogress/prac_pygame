...
enemy_x_pos = random.randrange(0, screen_width) # 화면 가로의 절반 크기에 해당하는 곳에 위치 (가로)
enemy_y_pos = - (enemy_height / 2) # 화면 세로 크기 가장 아래에 해당하는 곳에 위치 (세로)
    # 이동할 좌표
    # 이동속도
character_speed = 0.3
enemy_speed = 0.1
